        ...
        devShells.default = inputs.devenv.lib.mkShell {
          ...
          modules = [
            ({config, ...}: rec {
              ...
              # processes.wp-server.exec = "${pkgs.php}/bin/php -S localhost:8080";
              # processes.dev.exec = ''${pkgs.nodejs}/bin/npm --prefix "$PWD/web/app/themes/tecmobat" run dev'';
            })
          ];
        };
      };
